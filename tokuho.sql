...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-09-2024 a las 05:11:02
...
--
ALTER TABLE `dojo`
  MODIFY `idDojo` int(10) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tipousuario`
  MODIFY `idTipo` int(10) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT;
